...
def main():
    ...
    parser.add_argument("--local-path", required=True, help="Local path to the data directory")
    parser.add_argument("--s3-prefix", default="", help="S3 prefix (folder) for the uploaded files")
